    ...
    <ScrollView style={{flex: 1, paddingLeft: 5, paddingRight: 2}}>
      <Layout style={{flex: 1, justifyContent: 'space-between'}}>
        ...
        <Layout style={{marginVertical: 16}}>
          {/* <Text category="s1">Product Details</Text> */}
          ...
          {/* <Input
            ...
            onChangeText={text => onChangeInput('description', text)}
            style={{marginTop: 8}}
          /> */}
          ...
          {productData.isSubscriptionAvailable && (
            <>
              {/* <Input
                value={productData.rentalDetails.dailyPrice.toString()}
                label="Daily Price"
                placeholder="Enter daily rental price"
                onChangeText={text =>
                  onChangeInput('dailyPrice', text, 'rentalDetails')
                }
                keyboardType="numeric"
                style={{marginTop: 8}}
              /> */}
              ...
              />
              {/* <Input
                value={productData.rentalDetails.weeklyPrice.toString()}
                label="Weekly Price"
                placeholder="Enter weekly rental price"
                onChangeText={text =>
                  onChangeInput('weeklyPrice', text, 'rentalDetails')
                }
                keyboardType="numeric"
                style={{marginTop: 8}}
              /> */}
              ...
              />
              {/* <Input
                value={productData.rentalDetails.monthlyPrice.toString()}
                label="Monthly Price"
                placeholder="Enter monthly rental price"
                onChangeText={text =>
                  onChangeInput('monthlyPrice', text, 'rentalDetails')
                }
                keyboardType="numeric"
                style={{marginTop: 8}}
              /> */}
              ...
              />
              {/* <Input
                value={productData.rentalDetails.deposit.toString()}
                label="Deposit"
                placeholder="Enter deposit"
                onChangeText={text =>
                  onChangeInput('deposit', text, 'rentalDetails')
                }
                keyboardType="numeric"
                style={{marginTop: 8}}
              /> */}
